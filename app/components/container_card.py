...
class ContainerCard():
    def __init__(self, wrapper, container, start_callback=None, stop_callback=None, logs_callback=None, delete_callback=None):
        self.card = None
        self.active_dot = None
        self.setup(wrapper, container, start_callback=start_callback, stop_callback=stop_callback,
                   logs_callback=logs_callback, delete_callback=delete_callback)

    def setup(self, wrapper, container, start_callback=None, stop_callback=None, logs_callback=None, delete_callback=None):
